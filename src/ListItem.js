...
constructor(props){
    ...
    {
        "itemId":21984627,"name":"Hot Wheels 9-Car Gift Pack Collection (Styles May Vary)","salePrice":9.47,"shortDescription":"He and models for hours of fun.  Makes a wonderful gift for any occasion.","mediumImage":"https://i5.walmartimages.com/asr/85384b98-5da2-48a8-9147-a3f59cb4a94d_1.7b8b27224a37320e92ea70dca2ee15ce.jpeg?odnHeight=180&odnWidth=180&odnBg=FFFFFF",
    }
...
if(this.props.search==''){
    listOfMovies=this.state.movies.map((movie,index)=>{
        return <Details key={index} details={movie} add={this.props.add} delete={this.props.delete}/>
    })
}else{
    ...
    listOfMovies=filterMovies.map((movie,index)=>{
        return <Details keys={index} details={movie} add={this.props.add} delete={this.props.delete}/>
    })
}
